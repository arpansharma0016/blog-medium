    ...
    var FileDragging = MediumEditor.Extension.extend({
        ...
        insertImageFile: function (file) {
            ...
            fileReader.addEventListener('load', function (e) {
                ...
                addImageElement.setAttribute("class", "featured-image img-fluid")
        ...
        if (action === 'image') {
            ...
            <figure>
                <div style="width:100%;max-width:100%;text-align:center;">
                    <img class="featured-image img-fluid mb-0" src=${src}>
                    <a href="${src}" class="changedisplaysetting" style="font-size: 10px;">Image Source</a>
                </div>
            <figure><br>
            `;
            return this.options.ownerDocument.execCommand('insertHTML', false, imgsel)
